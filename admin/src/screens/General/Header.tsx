                        ...
                        <NavigationMenuList className="flex gap-4 lg:gap-8">
                            {navigationItems.map((item, index) => {
                                if (!(item.href.includes("#"))) {
                                    ...
                                    return (<NavigationMenuItem key={index}>
                                        <NavigationMenuLink asChild>
                                            <HashLink smooth to={item.href} className="font-bold text-gray-800 text-xs lg:text-sm tracking-wider hover:text-blue-600 transition-colors duration-200 px-2 py-1 whitespace-nowrap">
                                                {item.text}
                                            </HashLink>
                                        </NavigationMenuLink>
                                    </NavigationMenuItem>)
